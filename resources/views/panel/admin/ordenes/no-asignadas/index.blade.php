...
@include('panel.admin.components.flash-message')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-box w-auto">
                    <div class="dropdown-box__content box dark:bg-dark-1 p-2">
                        ...
                        <form action="{{route('ordersNA.import.excel')}}" method="POST" enctype="multipart/form-data">
                            @csrf
            ...
            <form action="{{route('ordenesNA.index')}}"  method="GET">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-auto">
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        <td>
                            <a class="items-center" href="{{route('ordenesNA.show',$orden->id)}}" title="Ver detalle"> <i data-feather="package" class="w-4 h-4 mr-1"></i></a>
                        </td>
                        <td>
                        ...
                        <td class="w-40">
                            @switch($orden->status)
                                ...
                                @default
                                <div class="flex items-center justify-center text-theme-9"> <i data-feather="check-square" class="w-4 h-4 mr-2"></i> Status no disponible </div>
                            @endswitch
                        ...
                        <td class="text-center">Contenedor no asignado</td>
                        @else
                        ...
                        <td class="text-center">Chassis no asignado</td>
                        @else
                        <td class="text-center">{{$orden->chassis}}</td>
                        @endif
                        <td class="table-report__action w-40">
                            <div class="flex justify-center items-center">
                                <a class="items-center mr-3" href="{{route('ordenesNA.edit',$orden->id)}}" title="Editar"> <i data-feather="pen-tool" class="w-4 h-4 mr-1"></i></a>
                                ...
                                <form action="{{route('ordenesNA.destroy',$orden->id)}}" class="delete-form" method="POST">
                                    @method('DELETE')
                                    @csrf
