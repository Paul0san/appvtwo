...
class UpdateOrderAsignedRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'booking_number' => 'required|alpha_num|unique:orders,booking_number,'. $this->route('ordenesA'),
            ...
            'chassis'=> 'unique:orders,chassis,'. $this->route('ordenesA'),
