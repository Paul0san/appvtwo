...
class UpdateOrderNAsignedRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'booking_number' => 'required|alpha_num|unique:orders,booking_number,'. $this->route('ordenesNA'),
            'equipment'=> 'required|alpha_num',
            'unit_number'=> 'required|regex:/^[A-Za-z0-9ÁÉÍÓÚáéíóúñÑ,-_ ]+$/',
            ...
            'chassis'=> 'sometimes|nullable|unique:orders,chassis,'. $this->route('ordenesNA'),
